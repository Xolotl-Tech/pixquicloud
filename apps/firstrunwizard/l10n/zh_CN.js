OC.L10N.register(
    ...
    "Growing sovereignty: new federation features, improved data export and import" : "主权扩展：新增联邦功能，优化数据导出与导入",
    "Nextcloud Talk: live translations, pinned messages, scheduling" : "Nextcloud Talk：实时翻译、置顶消息、定时发送",
    "Office document comparison" : "Office 文档比较",
    "Whiteboard: comments, reactions, timers" : "白板：评论、回应、计时器",
    "Nextcloud Assistant performance upgrade and AI labeling" : "Nextcloud 助手性能升级和 AI 标记功能",
    "Powerful E2EE in the web interface" : "Web 界面支持强大的端到端加密",
    "Speed-up with ADA engine" : "借助 ADA 引擎提升速度",
    "… and many more improvements in all apps!" : "… 以及所有应用的更多改进！",
    "Experience the brand new Nextcloud Hub!" : "立即体验全新的 Nextcloud Hub！",
    "Get to know the new features of Hub {version}" : "了解 Hub {version} 的新功能",
    "Time to own your collaboration: Meet Pixquicloud Hub 26 Winter! 🚀" : "掌握属于您的协作平台：迎接 Pixquicloud Hub 26 冬季版！🚀",
    "What's new?" : "有哪些更新？",
